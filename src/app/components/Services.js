...
export default function Services() {
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-4 bg-[#FAF4F2]">
      <h1 className={` ${loversQuarrel.className} text-8xl font-serif text-[#C09A92] `}>
        hello there gorgeous
      </h1>
      <h2 className={` ${anticDidone.className} text-3xl text-[#7D6B68] mt-4`}>
        BROW STUDIO LOCATED IN LAGOS
      </h2>
      <p className="text-[#7D6B68] max-w-2xl mt-4">
